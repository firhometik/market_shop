<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"G:\market_shop\public/../application/admin\view\category\index.html";i:1526893387;s:54:"G:\market_shop\application\admin\view\public\left.html";i:1526873354;s:56:"G:\market_shop\application\admin\view\public\footer.html";i:1526721238;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <div class="box-header  with-border">
                            <div class='pull-left'>
                                ...
                                <div class="pull-left xmr">
                                    ...
                                    <button class="btn btn-success btn-sm contentDel" data-toggle="modal" data-target="#Modal" data-remote="<?php echo url('category/getCategory',['parent_id'=>\think\Request::instance()->get('parent_id')]); ?>" >
                                        添加分类
                                    </button>
                                </div>
                            </div>
