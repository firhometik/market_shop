        ...
        function() {
            ...
            return u(e, [{
                ...
                value: function() {
                    ...
                    this._index--;
                    var t = l.getHash(location.href),
                    n = l.getRoute(this._routes, t);
            ...
            },
            {
                ...
                value: function(e) {
                    ...
                    function() {
                        ...
                        r.className && a.classList.add(r.className),
                        a.innerHTML = o,
                        t._$container.appendChild(a),
                        !n && t._options.enter && i && a.classList.add(t._options.enter),
                        t._options.enterTimeout > 0 ? setTimeout(function() {
                            a.classList.remove(t._options.enter)
                        },
                        t._options.enterTimeout) : a.classList.remove(t._options.enter),
                        location.hash = "#" + e;
                        try {
                            n ? t._index--:t._index++,
                        ...
                        "function" != typeof r.bind ||  (r.bind.call(a), r.__isBind = !0)
                    } (),
                    this
                }
            }]),
    ...
    function(e, t, n) {
        function r(e) {
            for (var t, n = [], r = 0, o = 0, i = ""; null != (t = g.exec(e));) {
                ...
                u = t[1],
                l = t.index;
                if (i += e.slice(o, l), o = l + a.length, u) i += u[1];
                else {
                    var c = e[o],
                    f = t[2],
                    p = t[3],
        ...
        function a(e) {
            ...
            return function(n, r) {
                ...
                a = n || {},
                u = r || {},
                s = u.pretty ? i: encodeURIComponent, l = 0; l < e.length; l++) {
                    var c = e[l];
                    if ("string" != typeof c) {
                        var f, p = a[c.name];
                        if (null == p) {
        ...
        function h(e, t) {
            ...
            r = t.end !== !1,
            o = "",
            i = e[e.length - 1], a = "string" == typeof i && /\/$/.test(i), s = 0; s < e.length; s++) {
                var l = e[s];
        ...
        function v(e, t, n) {
            return t = t || [],
            _(t) ? n || (n = {}) : (n = t, t = []),
            e instanceof RegExp ? f(e, t) : _(e) ? p(e, t, n) : d(e, t, n)
        }
        var _ = n(3);
        e.exports = v,
        e.exports.parse = r,
